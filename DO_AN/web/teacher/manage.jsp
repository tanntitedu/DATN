                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <a href="/DO_AN/StudentManager?p=manage-user"><img class="img-thumbnail" src="./images/admin/user.png" alt="" width="40%"/></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4" style="background:">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <a href="/DO_AN/QuizManager?p=manage-quiz"><img class="img-thumbnail" src="./images/admin/12.png" alt="" width="40%"/></a>
                            </div>
                        </div>
                    </div>
                </div>
