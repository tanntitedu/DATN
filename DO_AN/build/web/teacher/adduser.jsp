                ...
                <div class="col-lg-4 col-md-offset-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3><span class="glyphicon glyphicon-user"></span>${us.getUserId() > 0 ? 'Thay đổi thông tin học sinh' : 'Thêm mới học sinh'}</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" action="/DO_AN/StudentManager?id=${us.getUserId()}" method="post">
                                <!-- /.UserName -->
